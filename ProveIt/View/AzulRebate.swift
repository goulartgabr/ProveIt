                ...
                .overlay{
                    ...
                    if showTutorial == true {
                        ZStack{
                            ...
                            LocalizedImage3(named: "?8")
                                .padding(.bottom, 360)
                        }
                    }
                }
            }
            if nextViewIsOpen && !showingAzulRebate{
                VermelhaFinaliza()
                    .transition(.identity)
            }
        }
...
struct AzulRebate_Previews: PreviewProvider {
