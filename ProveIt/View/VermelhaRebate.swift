...
//                        .blur(radius: 2)
                ...
                .navigationBarTitle(Text("RESPOSTA"))
        ...
        if nextViewIsOpen && !showingVermelhaRebate{
            AzulFinaliza()
                .transition(.identity)
        }
    }
...
struct VermelhaRebate_Previews: PreviewProvider {
