                    ...
                    Image("Elipse")
                        ...
                        .onAppear{
                            ...
                            DispatchQueue.main.asyncAfter(deadline: .now() + 2){
                                withAnimation{
                                    nextViewIsOpen = true
                                    showingVermelhaFinaliza.toggle()
                                }
                        }
                        }
            ...
            .overlay{
                ...
                if showTutorial == true {
                    ZStack{
                        ...
                        LocalizedImage3(named: "?9")
                            .padding(.bottom, 360)
                    }
                }
            }
        }
        if nextViewIsOpen && !showingVermelhaFinaliza{
            GameOverView()
                .transition(.opacity)
        }
    }
...
struct VermelhaFinaliza_Previews: PreviewProvider {
